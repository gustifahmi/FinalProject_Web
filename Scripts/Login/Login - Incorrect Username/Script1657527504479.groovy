...
WebUI.verifyElementVisible(findTestObject('Login Page/Alert - Incorrect Password (Above Username)'))

WebUI.verifyElementVisible(findTestObject('Login Page/Alert - Incorrect Password'))
